...
type
  TCef3ChromiumDevTools = class(TWinControl)
  protected
  ...
  TCef3CustomChromium = class(TWinControl, IChromiumEvents)
  private
    FHandler: ICefClient;
  ...
  TCef3CustomChromiumOSR = class(TComponent, IChromiumEvents)
  private
    FHandler: ICefClient;
    FBrowser: ICefBrowser;
    FBrowserId: Integer;
  ...
  TCef3Chromium = class(TCef3CustomChromium)
  public
    property BrowserId;
    property Browser;
  published
  ...
  TCef3ChromiumOSR = class(TCef3CustomChromiumOSR)
  public
    property BrowserId;
    property Browser;
  published
...
procedure TCef3CustomChromium.CloseDevTools;
begin
  if (FBrowser <> nil) then
    FBrowser.Host.CloseDevTools;
end;

constructor TCef3CustomChromium.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TCef3CustomChromium.CreateBrowser;
var
  info: TCefWindowInfo;
...
procedure TCef3CustomChromium.CreateWindowHandle(const Params: TCreateParams);
begin
  inherited;
  CreateBrowser;
end;
...
destructor TCef3CustomChromium.Destroy;
begin
  if FBrowser <> nil then
  begin
    FBrowser.StopLoad;
...
function TCef3CustomChromium.GetClientHandler: ICefClient;
begin
  Result := TVCLClientHandler.Create(Self, False);
end;

procedure TCef3CustomChromium.GetSettings(var settings: TCefBrowserSettings);
begin
...
procedure TCef3CustomChromium.Load(const url: ustring);
var
  frm: ICefFrame;
begin
  HandleNeeded;
...
procedure TCef3CustomChromium.Loaded;
begin
  inherited;
  Load(FDefaultUrl);
end;

procedure TCef3CustomChromium.ReCreateBrowser(const url: string);
begin
...
procedure TCef3CustomChromium.Resize;
var
  brws: ICefBrowser;
  rect: TRect;
  hdwp: THandle;
...
procedure TCef3CustomChromium.ShowDevTools(inspectElementAt: PCefPoint);
var
  info: TCefWindowInfo;
...
procedure TCef3CustomChromium.WndProc(var Message: TMessage);
begin
  case Message.Msg of
    WM_SETFOCUS:
      begin
...
function TCef3CustomChromium.doOnClose(const browser: ICefBrowser): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromium.doOnAddressChange(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnAfterCreated(const browser: ICefBrowser);
begin
  if Assigned(FOnAfterCreated) then
    FOnAfterCreated(Self, browser);
end;

function TCef3CustomChromium.doOnBeforeBrowse(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnBeforeClose(const browser: ICefBrowser);
begin
  if Assigned(FOnBeforeClose) then
    FOnBeforeClose(Self, browser);
end;

procedure TCef3CustomChromium.doOnBeforeContextMenu(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnBeforeDownload(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnBeforePluginLoad(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnBeforePopup(const browser: ICefBrowser;
  const frame: ICefFrame; const targetUrl, targetFrameName: ustring;
  var popupFeatures: TCefPopupFeatures; var windowInfo: TCefWindowInfo;
  var client: ICefClient; var settings: TCefBrowserSettings;
...
function TCef3CustomChromium.doOnBeforeResourceLoad(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnBeforeUnloadDialog(const browser: ICefBrowser;
  const messageText: ustring; isReload: Boolean;
...
procedure TCef3CustomChromium.doOnCancelGeolocationPermission(
...
function TCef3CustomChromium.doOnCertificateError(certError: TCefErrorCode;
...
function TCef3CustomChromium.doOnConsoleMessage(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnContextMenuCommand(const browser: ICefBrowser;
  const frame: ICefFrame; const params: ICefContextMenuParams;
...
procedure TCef3CustomChromium.doOnContextMenuDismissed(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnCursorChange(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnDialogClosed(const browser: ICefBrowser);
begin
  if Assigned(FOnDialogClosed) then
    FOnDialogClosed(Self, browser);
end;

procedure TCef3CustomChromium.doOnDownloadUpdated(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnDragEnter(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnFileDialog(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnGetAuthCredentials(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnGetResourceHandler(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnGetRootScreenRect(const browser: ICefBrowser;
  rect: PCefRect): Boolean;
begin
  Result := False;
end;

function TCef3CustomChromium.doOnGetScreenInfo(const browser: ICefBrowser;
  screenInfo: PCefScreenInfo): Boolean;
begin
  Result := False;
end;

function TCef3CustomChromium.doOnGetScreenPoint(const browser: ICefBrowser; viewX,
  viewY: Integer; screenX, screenY: PInteger): Boolean;
begin
  Result := False;
end;

function TCef3CustomChromium.doOnGetViewRect(const browser: ICefBrowser;
  rect: PCefRect): Boolean;
begin
  Result := False;
end;

procedure TCef3CustomChromium.doOnGotFocus(const browser: ICefBrowser);
begin
  if Assigned(FOnGotFocus) then
    FOnGotFocus(Self, browser)
end;

function TCef3CustomChromium.doOnJsdialog(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnKeyEvent(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnLoadEnd(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnLoadError(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnLoadingStateChange(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnLoadStart(const browser: ICefBrowser;
  const frame: ICefFrame);
begin
...
procedure TCef3CustomChromium.doOnPaint(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnPluginCrashed(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnPopupShow(const browser: ICefBrowser;
  show: Boolean);
begin

end;

procedure TCef3CustomChromium.doOnPopupSize(const browser: ICefBrowser;
  const rect: PCefRect);
begin

end;

function TCef3CustomChromium.doOnPreKeyEvent(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnProcessMessageReceived(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnProtocolExecution(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnQuotaRequest(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnRenderProcessTerminated(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnRequestGeolocationPermission(
  const browser: ICefBrowser; const requestingUrl: ustring; requestId: Integer;
...
procedure TCef3CustomChromium.doOnResetDialogState(const browser: ICefBrowser);
begin
  if Assigned(FOnResetDialogState) then
    FOnResetDialogState(Self, browser);
end;

procedure TCef3CustomChromium.doOnResourceRedirect(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnScrollOffsetChanged(const browser: ICefBrowser);
begin

end;

function TCef3CustomChromium.doOnSetFocus(const browser: ICefBrowser;
...
function TCef3CustomChromium.doOnStartDragging(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnStatusMessage(const browser: ICefBrowser;
  const value: ustring);
begin
...
procedure TCef3CustomChromium.doOnTakeFocus(const browser: ICefBrowser;
  next: Boolean);
begin
...
procedure TCef3CustomChromium.doOnTitleChange(const browser: ICefBrowser;
  const title: ustring);
begin
...
function TCef3CustomChromium.doOnTooltip(const browser: ICefBrowser;
...
procedure TCef3CustomChromium.doOnUpdateDragCursor(const browser: ICefBrowser;
  operation: TCefDragOperation);
begin

end;

function TCef3CustomChromium.doOnRunModal(const browser: ICefBrowser): Boolean;
begin
  Result := False;
...
{ TCef3CustomChromiumOSR }

constructor TCef3CustomChromiumOSR.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TCef3CustomChromiumOSR.CreateBrowser;
var
  info: TCefWindowInfo;
  settings: TCefBrowserSettings;
begin
...
destructor TCef3CustomChromiumOSR.Destroy;
begin
...
function TCef3CustomChromiumOSR.GetClientHandler: ICefClient;
begin
  Result := TVCLClientHandler.Create(Self, True);
end;

procedure TCef3CustomChromiumOSR.GetSettings(var settings: TCefBrowserSettings);
begin
  Assert(settings.size >= SizeOf(settings));
  settings.windowless_frame_rate := FOptions.WindowlessFrameRate;
...
procedure TCef3CustomChromiumOSR.Load(const url: ustring);
var
  frm: ICefFrame;
begin
  if FBrowser <> nil then
...
procedure TCef3CustomChromiumOSR.Loaded;
begin
  inherited;
  CreateBrowser;
  Load(FDefaultUrl);
...
procedure TCef3CustomChromiumOSR.ReCreateBrowser(const url: string);
begin
  if (FBrowser <> nil) and (FBrowserId <> 0) then
  begin
    SendMessage(FBrowser.Host.WindowHandle, WM_CLOSE, 0, 0);
...
function TCef3CustomChromiumOSR.doOnClose(const browser: ICefBrowser): Boolean;
begin
  Result := False;
  if Assigned(FOnClose) then
    FOnClose(Self, browser, Result);
...
procedure TCef3CustomChromiumOSR.doOnAddressChange(const browser: ICefBrowser;
  const frame: ICefFrame; const url: ustring);
begin
  if Assigned(FOnAddressChange) then
    FOnAddressChange(Self, browser, frame, url);
...
procedure TCef3CustomChromiumOSR.doOnAfterCreated(const browser: ICefBrowser);
begin
  if Assigned(FOnAfterCreated) then
    FOnAfterCreated(Self, browser);
end;

function TCef3CustomChromiumOSR.doOnBeforeBrowse(const browser: ICefBrowser;
  const frame: ICefFrame; const request: ICefRequest;
  isRedirect: Boolean): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromiumOSR.doOnBeforeClose(const browser: ICefBrowser);
begin
  if Assigned(FOnBeforeClose) then
    FOnBeforeClose(Self, browser);
end;

procedure TCef3CustomChromiumOSR.doOnBeforeContextMenu(const browser: ICefBrowser;
  const frame: ICefFrame; const params: ICefContextMenuParams;
  const model: ICefMenuModel);
begin
  if Assigned(FOnBeforeContextMenu) then
...
procedure TCef3CustomChromiumOSR.doOnBeforeDownload(const browser: ICefBrowser;
  const downloadItem: ICefDownloadItem; const suggestedName: ustring;
  const callback: ICefBeforeDownloadCallback);
begin
  if Assigned(FOnBeforeDownload) then
...
function TCef3CustomChromiumOSR.doOnBeforePluginLoad(const browser: ICefBrowser;
  const url, policyUrl: ustring; const info: ICefWebPluginInfo): Boolean;
begin
  Result := False;
  if Assigned(FOnBeforePluginLoad) then
...
function TCef3CustomChromiumOSR.doOnBeforePopup(const browser: ICefBrowser;
      const frame: ICefFrame; const targetUrl, targetFrameName: ustring;
      var popupFeatures: TCefPopupFeatures; var windowInfo: TCefWindowInfo;
      var client: ICefClient; var settings: TCefBrowserSettings;
      var noJavascriptAccess: Boolean): Boolean;
...
function TCef3CustomChromiumOSR.doOnBeforeResourceLoad(const browser: ICefBrowser;
  const frame: ICefFrame; const request: ICefRequest): Boolean;
begin
  Result := False;
  if Assigned(FOnBeforeResourceLoad) then
...
function TCef3CustomChromiumOSR.doOnBeforeUnloadDialog(const browser: ICefBrowser;
  const messageText: ustring; isReload: Boolean;
  const callback: ICefJsDialogCallback): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromiumOSR.doOnCancelGeolocationPermission(
  const browser: ICefBrowser; const requestingUrl: ustring; requestId: Integer);
begin
  if Assigned(FOnCancelGeolocationPermission) then
    FOnCancelGeolocationPermission(Self, browser, requestingUrl, requestId);
...
function TCef3CustomChromiumOSR.doOnCertificateError(certError: TCefErrorCode;
  const requestUrl: ustring;
  const callback: ICefAllowCertificateErrorCallback): Boolean;
begin
  Result := False;
...
function TCef3CustomChromiumOSR.doOnConsoleMessage(const browser: ICefBrowser;
  const message, source: ustring; line: Integer): Boolean;
begin
  Result := False;
  if Assigned(FOnConsoleMessage) then
...
function TCef3CustomChromiumOSR.doOnContextMenuCommand(const browser: ICefBrowser;
  const frame: ICefFrame; const params: ICefContextMenuParams;
  commandId: Integer; eventFlags: TCefEventFlags): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromiumOSR.doOnContextMenuDismissed(const browser: ICefBrowser;
  const frame: ICefFrame);
begin
  if Assigned(FOnContextMenuDismissed) then
    FOnContextMenuDismissed(Self, browser, frame);
...
procedure TCef3CustomChromiumOSR.doOnCursorChange(const browser: ICefBrowser;
...
procedure TCef3CustomChromiumOSR.doOnDialogClosed(const browser: ICefBrowser);
begin
  if Assigned(FOnDialogClosed) then
    FOnDialogClosed(Self, browser);
end;

procedure TCef3CustomChromiumOSR.doOnDownloadUpdated(const browser: ICefBrowser;
  const downloadItem: ICefDownloadItem;
  const callback: ICefDownloadItemCallback);
begin
  if Assigned(FOnDownloadUpdated) then
...
function TCef3CustomChromiumOSR.doOnDragEnter(const browser: ICefBrowser;
  const dragData: ICefDragData; mask: TCefDragOperations): Boolean;
begin
  Result := False;
  if Assigned(FOnDragEnter) then
...
function TCef3CustomChromiumOSR.doOnFileDialog(const browser: ICefBrowser;
  mode: TCefFileDialogMode; const title, defaultFileName: ustring;
  acceptTypes: TStrings; const callback: ICefFileDialogCallback): Boolean;
begin
  Result := False;
...
function TCef3CustomChromiumOSR.doOnGetAuthCredentials(const browser: ICefBrowser;
  const frame: ICefFrame; isProxy: Boolean; const host: ustring; port: Integer;
  const realm, scheme: ustring; const callback: ICefAuthCallback): Boolean;
begin
  Result := False;
...
function TCef3CustomChromiumOSR.doOnGetResourceHandler(const browser: ICefBrowser;
  const frame: ICefFrame; const request: ICefRequest): ICefResourceHandler;
begin
  if Assigned(FOnGetResourceHandler) then
    FOnGetResourceHandler(Self, browser, frame, request, Result) else
...
function TCef3CustomChromiumOSR.doOnGetRootScreenRect(const browser: ICefBrowser;
  rect: PCefRect): Boolean;
begin
  Result := False;
...
function TCef3CustomChromiumOSR.doOnGetScreenInfo(const browser: ICefBrowser;
  screenInfo: PCefScreenInfo): Boolean;
begin
  Result := False;
...
function TCef3CustomChromiumOSR.doOnGetScreenPoint(const browser: ICefBrowser; viewX,
  viewY: Integer; screenX, screenY: PInteger): Boolean;
begin
  Result := False;
...
function TCef3CustomChromiumOSR.doOnGetViewRect(const browser: ICefBrowser;
  rect: PCefRect): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromiumOSR.doOnGotFocus(const browser: ICefBrowser);
begin
  if Assigned(FOnGotFocus) then
    FOnGotFocus(Self, browser)
end;

function TCef3CustomChromiumOSR.doOnJsdialog(const browser: ICefBrowser;
  const originUrl, acceptLang: ustring; dialogType: TCefJsDialogType;
  const messageText, defaultPromptText: ustring; callback: ICefJsDialogCallback;
  out suppressMessage: Boolean): Boolean;
begin
...
function TCef3CustomChromiumOSR.doOnKeyEvent(const browser: ICefBrowser;
  const event: PCefKeyEvent; osEvent: TCefEventHandle): Boolean;
begin
  Result := False;
  if Assigned(FOnKeyEvent) then
...
procedure TCef3CustomChromiumOSR.doOnLoadEnd(const browser: ICefBrowser;
  const frame: ICefFrame; httpStatusCode: Integer);
begin
  if Assigned(FOnLoadEnd) then
    FOnLoadEnd(Self, browser, frame, httpStatusCode);
...
procedure TCef3CustomChromiumOSR.doOnLoadError(const browser: ICefBrowser;
  const frame: ICefFrame; errorCode: Integer; const errorText,
  failedUrl: ustring);
begin
  if Assigned(FOnLoadError) then
...
procedure TCef3CustomChromiumOSR.doOnLoadingStateChange(const browser: ICefBrowser;
  isLoading, canGoBack, canGoForward: Boolean);
begin
  if Assigned(FOnLoadingStateChange) then
    FOnLoadingStateChange(Self, browser, isLoading, canGoBack, canGoForward);
...
procedure TCef3CustomChromiumOSR.doOnLoadStart(const browser: ICefBrowser;
  const frame: ICefFrame);
begin
  if Assigned(FOnLoadStart) then
    FOnLoadStart(Self, browser, frame);
...
procedure TCef3CustomChromiumOSR.doOnPaint(const browser: ICefBrowser;
  kind: TCefPaintElementType; dirtyRectsCount: NativeUInt;
  const dirtyRects: PCefRectArray; const buffer: Pointer; width, height: Integer);
begin
...
procedure TCef3CustomChromiumOSR.doOnPluginCrashed(const browser: ICefBrowser;
  const pluginPath: ustring);
begin
  if Assigned(FOnPluginCrashed) then
    FOnPluginCrashed(Self, browser, pluginPath);
...
procedure TCef3CustomChromiumOSR.doOnPopupShow(const browser: ICefBrowser;
  show: Boolean);
begin
...
procedure TCef3CustomChromiumOSR.doOnPopupSize(const browser: ICefBrowser;
  const rect: PCefRect);
begin
...
function TCef3CustomChromiumOSR.doOnPreKeyEvent(const browser: ICefBrowser;
  const event: PCefKeyEvent; osEvent: TCefEventHandle;
  out isKeyboardShortcut: Boolean): Boolean;
begin
  Result := False;
...
function TCef3CustomChromiumOSR.doOnProcessMessageReceived(const browser: ICefBrowser;
  sourceProcess: TCefProcessId; const message: ICefProcessMessage): Boolean;
begin
  Result := False;
  if Assigned(FOnProcessMessageReceived) then
...
procedure TCef3CustomChromiumOSR.doOnProtocolExecution(const browser: ICefBrowser;
  const url: ustring; out allowOsExecution: Boolean);
begin
  if Assigned(FOnProtocolExecution) then
    FOnProtocolExecution(Self, browser, url, allowOsExecution);
...
function TCef3CustomChromiumOSR.doOnQuotaRequest(const browser: ICefBrowser;
  const originUrl: ustring; newSize: Int64;
  const callback: ICefQuotaCallback): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromiumOSR.doOnRenderProcessTerminated(const browser: ICefBrowser;
  status: TCefTerminationStatus);
begin
  if Assigned(FOnRenderProcessTerminated) then
    FOnRenderProcessTerminated(Self, browser, status);
...
function TCef3CustomChromiumOSR.doOnRequestGeolocationPermission(
  const browser: ICefBrowser; const requestingUrl: ustring; requestId: Integer;
  const callback: ICefGeolocationCallback): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromiumOSR.doOnResetDialogState(const browser: ICefBrowser);
begin
  if Assigned(FOnResetDialogState) then
    FOnResetDialogState(Self, browser);
end;

procedure TCef3CustomChromiumOSR.doOnResourceRedirect(const browser: ICefBrowser;
  const frame: ICefFrame; const oldUrl: ustring; var newUrl: ustring);
begin
  if Assigned(FOnResourceRedirect) then
    FOnResourceRedirect(Self, browser, frame, oldUrl, newUrl);
...
procedure TCef3CustomChromiumOSR.doOnScrollOffsetChanged(
...
function TCef3CustomChromiumOSR.doOnSetFocus(const browser: ICefBrowser;
  source: TCefFocusSource): Boolean;
begin
  Result := False;
  if Assigned(FOnSetFocus) then
...
function TCef3CustomChromiumOSR.doOnStartDragging(const browser: ICefBrowser;
  const dragData: ICefDragData; allowedOps: TCefDragOperations; x,
  y: Integer): Boolean;
begin
  Result := False;
...
procedure TCef3CustomChromiumOSR.doOnStatusMessage(const browser: ICefBrowser;
  const value: ustring);
begin
  if Assigned(FOnStatusMessage) then
    FOnStatusMessage(Self, browser, value);
...
procedure TCef3CustomChromiumOSR.doOnTakeFocus(const browser: ICefBrowser;
  next: Boolean);
begin
  if Assigned(FOnTakeFocus) then
    FOnTakeFocus(Self, browser, next);
...
procedure TCef3CustomChromiumOSR.doOnTitleChange(const browser: ICefBrowser;
  const title: ustring);
begin
  if Assigned(FOnTitleChange) then
    FOnTitleChange(Self, browser, title);
...
function TCef3CustomChromiumOSR.doOnTooltip(const browser: ICefBrowser;
  var text: ustring): Boolean;
begin
  Result := False;
  if Assigned(FOnTooltip) then
...
procedure TCef3CustomChromiumOSR.doOnUpdateDragCursor(const browser: ICefBrowser;
  operation: TCefDragOperation);
begin
...
function TCef3CustomChromiumOSR.doOnRunModal(const browser: ICefBrowser): Boolean;
begin
  Result := False;
  if Assigned(FOnRunModal) then
    FOnRunModal(Self, browser, Result);
...
{ TCef3ChromiumDevTools }

procedure TCef3ChromiumDevTools.CloseDevTools(const browser: ICefBrowser);
begin
  if browser <> nil then
  begin
...
procedure TCef3ChromiumDevTools.Resize;
var
  rect: TRect;
  hdwp: THandle;
  hndl: THandle;
...
procedure TCef3ChromiumDevTools.ShowDevTools(const browser: ICefBrowser;
...
procedure TCef3ChromiumDevTools.WndProc(var Message: TMessage);
var
  hndl: THandle;
begin
  case Message.Msg of
